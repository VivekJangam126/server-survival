...
class ModeControllerManager {
    ...
    async registerModeControllers() {
        try {
            ...
            const { PlayModeController } = await import('../controllers/PlayModeController.js');
            ...
            const { LearnModeController } = await import('../controllers/LearnModeController.js');
            ...
            const { AnalysisModeController } = await import('../controllers/AnalysisModeController.js');
            ...
            const { ProfileModeController } = await import('../controllers/ProfileModeController.js');
