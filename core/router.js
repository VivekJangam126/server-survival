...
class Router {
    ...
    registerModes() {
        this.modes = {
            ...
            challenges: {
                title: 'Challenges',
                component: 'challengesMode',
                preserveState: true,
                requiresAuth: false,
                url: '/public/challenges.html'
            },
            leaderboard: {
                title: 'Leaderboard',
                component: 'leaderboardMode',
                preserveState: true,
                requiresAuth: false,
    ...
    async navigateTo(mode, options = {}) {
        try {
            ...
            // If mode has a URL, navigate to that page
            if (modeConfig.url) {
                window.location.href = modeConfig.url;
                return true;
            }
    ...
    /**
     * Navigate using absolute URLs (for cross-page navigation)
     */
    navigateToUrl(url) {
    ...
    /**
     * Navigate to mode by name (convenience method)
     */
    navigate(mode, options = {}) {
        return this.navigateTo(mode, options);
    }
